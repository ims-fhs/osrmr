...
run_server("C:/OSRM_API5/", "switzerland-latest.osrm") # start localhost of OSRM API 5
quit_server() # quit the running server
run_server("C:/OSRM_API4/", "switzerland-latest.osrm") # start localhost of OSRM API 4
quit_server() # quit the running server
```
...
# run_server("C:/OSRM_API5/", "switzerland-latest.osrm")
# nearest(lat = 47, lng = 8, api_version = 5, localhost = TRUE)
# quit_server()
#        lat      lng
# 1 47.00008 8.003016

# run_server("C:/OSRM_API4/", "switzerland-latest.osrm")
